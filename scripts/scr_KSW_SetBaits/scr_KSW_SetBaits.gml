...
function scr_KSW_SetBaits()
{
	...
	scr_KSW_AddBait("0rarity","Glod Berry","More 0 rarity fish!",spr_KSW_Bait_Icon_GlodBerry,spr_KSW_Bait_Texture_GlodBerry,glimmer,0,0,25);
	scr_KSW_AddBait("1rarity","Rare Cookie","More 1 rarity fish!",spr_KSW_Bait_Icon_RareCookie,spr_KSW_Bait_Texture_RareCookie,borange,0,0,50);
	scr_KSW_AddBait("2rarity","Big Bun","More 2 rarity fish!",spr_KSW_Bait_Icon_BigBun,spr_KSW_Bait_Texture_BigBun,borange,0,0,100);
	scr_KSW_AddBait("3rarity","Starfruit","More 3 rarity fish!",spr_KSW_Bait_Icon_Starfruit,spr_KSW_Bait_Texture_Starfruit,mint,0,0,200);
	scr_KSW_AddBait("extraDay","Sundae","Extra Daytime fish!",spr_KSW_Bait_Icon_Sundae,spr_KSW_Bait_Texture_Sundae,mage,0,0,150);
	scr_KSW_AddBait("extraAfternoon","Love Egg","Extra Afternoon fish!",spr_KSW_Bait_Icon_LoveEgg,spr_KSW_Bait_Texture_LoveEgg,borange,0,0,150);
	scr_KSW_AddBait("extraNight","Mooncake","Extra Nighttime fish!",spr_KSW_Bait_Icon_Mooncake,spr_KSW_Bait_Texture_Mooncake,flux,0,0,150);
	scr_KSW_AddBait("easyInputs","Ruffpaste","Easier catch inputs!",spr_KSW_Bait_Icon_Ruffpaste,spr_KSW_Bait_Texture_Ruffpaste,mage,0,0,100);
	scr_KSW_AddBait("fasterFinds","Rush Pepper","Less waiting time!",spr_KSW_Bait_Icon_RushPepper,spr_KSW_Bait_Texture_RushPepper,candy,0,0,100);
